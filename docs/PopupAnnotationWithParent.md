# Aspose.Pdf.Cloud.Sdk.Model.PopupAnnotationWithParent
...
**Open** | **bool?** | Gets or sets a flag specifying whether the pop-up annotation should initially be displayed open. | [optional] 

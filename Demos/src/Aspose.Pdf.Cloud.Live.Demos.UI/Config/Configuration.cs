...
namespace Aspose.Pdf.Cloud.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _AsposePDFCloudLiveDemosPath = ConfigurationManager.AppSettings["AsposePDFCloudLiveDemosPath"].ToString();
		...
		private static string _AsposePDFCloudAppsAssetURL = ConfigurationManager.AppSettings["AsposePDFCloudAppsAssetURL"];
		...
		public static string AsposePDFCloudLiveDemosPath
		{
			get { return _AsposePDFCloudLiveDemosPath; }
		}		
		...
		public static string AsposePDFCloudAppsAssetURL
		{
            get { return _AsposePDFCloudAppsAssetURL; }
        }

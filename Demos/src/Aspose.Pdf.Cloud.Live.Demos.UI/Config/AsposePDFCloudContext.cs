...
{
	/// <summary>
	/// Wrapper class for Aspose.PDF Cloud Tools context access to Pages and controls
	/// </summary>
	public class AsposePDFCloudContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposePDFCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposePDFCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposePDFCloudContext atcc { set { atc = value; } }
		internal static AsposePDFCloudContext Current
		{
			get { return atc; }
		}
